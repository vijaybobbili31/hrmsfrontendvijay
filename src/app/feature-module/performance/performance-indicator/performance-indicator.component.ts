...
export class PerformanceIndicatorComponent implements OnInit {
  ...
  public addIndicatorForm: FormGroup | any;
  public editIndicatorForm: FormGroup | any;
  ...
  private getTableData(): void {
    ...
    this.data.getPerformanceReport().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstindicator);
