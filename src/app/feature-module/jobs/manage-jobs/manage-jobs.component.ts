...
export class ManageJobsComponent implements OnInit {
  ...
  public addManageJobs: FormGroup | any ;
  public editManageJobs: FormGroup | any;
  //** / pagination variables
  ...
  private getTableData(): void {
    ...
    this.data.getManageJobs().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.allManageJobs);
