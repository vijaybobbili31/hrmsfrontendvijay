...
export class InterviewQuestionsComponent implements OnInit {
  public addInterviewForm: FormGroup | any;
  public editInterviewForm: FormGroup | any;
  public lstInterview: any = [];
  ...
  private getTableData(): void {
    ...
    this.data.getInterview().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstInterview);
