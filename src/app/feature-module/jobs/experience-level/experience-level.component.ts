...
export class ExperienceLevelComponent implements OnInit {
  public addExpireForm: FormGroup | any;
  public editExpireForm: FormGroup | any;
  public lstExpire: any = [];
  ...
  private getTableData(): void {
    ...
    this.data.getExpire().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstExpire);
