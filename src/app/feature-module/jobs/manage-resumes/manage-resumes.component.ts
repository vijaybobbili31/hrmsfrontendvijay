...
export class ManageResumesComponent implements OnInit {
  ...
  public editCandidateForm: FormGroup | any;
  public lstManage: any = [];
  ...
  private getTableData(): void {
    ...
    this.data.getManageResume().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstManage);
