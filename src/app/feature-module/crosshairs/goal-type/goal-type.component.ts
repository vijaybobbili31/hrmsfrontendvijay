...
export class GoalTypeComponent implements OnInit {
  public lstGoaltype: any = [];
  public addGoalTypeForm: FormGroup | any;
  public editGoalTypeForm: FormGroup | any;
  ...
  private getTableData(): void {
    ...
    this.data.getGoalType().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstGoaltype);
