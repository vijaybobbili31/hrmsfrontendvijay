...
export class ResMainComponent implements OnInit {
  ...
  public lstResignation: any = [];
  public addResignForm: FormGroup | any;
  public editResignForm: FormGroup | any;
  ...
  private getTableData(): void {
    ...
    this.data.getResignation().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstResignation);
