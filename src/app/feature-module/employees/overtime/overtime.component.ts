...
export class OvertimeComponent implements OnInit {
  public addOvertimeForm: FormGroup | any;
  public editOvertimeForm: FormGroup | any;
  public statusValue: any;
  public lstOvertime: any = [];
  ...
  private getTableData(): void {
    ...
    this.data.getOverTime().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.lstOvertime);
