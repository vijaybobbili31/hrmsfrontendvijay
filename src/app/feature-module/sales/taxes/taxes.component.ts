...
export class TaxesComponent implements OnInit {
  public addTaxes: FormGroup | any;
  public editTaxForm: FormGroup | any;
  public allTaxes: any = [];
  ...
  private getTableData(): void {
    ...
    this.data.getTaxes().subscribe((res: any) => {
      ...
      this.dataSource = new MatTableDataSource<any>(this.allTaxes);
